...
const globalPrefs: Field[] = [
  ...
  field(
    ...
    Str,
    "",
    "legacy remembered engine for Translate Selection; ignored by HTTP translation providers",
  )
    .internal()
    .ver("3.7"),
  field(
    ...
    Str,
    null,
    "provider for selection translation: OpenAI-compatible, Google Cloud Translation or Microsoft Translator; empty disables requests",
  ).ver("3.7"),
  field(
    "TranslationOpenAIBaseUrl",
    Str,
    null,
    "base URL for the OpenAI-compatible translation API; /chat/completions is added automatically",
  ).ver("3.7"),
  field("TranslationOpenAIModel", Str, null, "model for the OpenAI-compatible translation API").ver("3.7"),
  field(
    "TranslationOpenAIKey",
    Str,
    null,
    "API key for the OpenAI-compatible translation API; stored in plain text in this settings file",
  ).ver("3.7"),
  field(
    "TranslationGoogleKey",
    Str,
    null,
    "API key for Google Cloud Translation; stored in plain text in this settings file",
  ).ver("3.7"),
  field(
    "TranslationMicrosoftEndpoint",
    Str,
    null,
    "endpoint for Microsoft Translator, for example https://api.cognitive.microsofttranslator.com",
  ).ver("3.7"),
  field(
